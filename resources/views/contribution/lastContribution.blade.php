            ...
            <div class="panel-body">
                ...
                <div class="panel panel-flat">
                    <div class="panel-heading">
                        <h5 class="panel-title">Contribution Type<a class="heading-elements-toggle"><i
                        ...
                        <div class="datatable-scroll">
                            <table class="table datatable-html dataTable no-footer" id="DataTables_Table_0" role="grid"
                                ...
                                <tr role="row" class="odd">
                                    <td class="sorting_1">{{$contribution->benevolent_contribution_type}}</td>
                                    <td>{{$contribution->shares_contribution_type}}</td>
                                    <td>{{$contribution->loan_payment_contribution_type}}</td>
                                    <td>{{$contribution->Miscellaneous_contribution_type}}</td>
                                    <td><span class="label label-danger">{{$contribution->merry_go_round_contribution_type}}</span></td>
